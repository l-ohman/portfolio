  ...
  return (
    <>
      ...
      <DescriptionImagesContainer>
        ...
        <p className="description">{`I was the lead UI/UX designer and frontend engineer on this project. When beginning this process, I understood that the functionality our clients were looking for necessitated an extremely complex UI in order to display a wide variety of information. However, it also needed to be straightforward so users could easily navigate and use the wealth of information provided to them. After many rounds of experimentation, feedback, and iteration, I had created an intricate but intuitive interface that was extremely well received by the users.`}</p>
